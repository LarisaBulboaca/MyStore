...
namespace MyStore.Domain.Migrations
{
    ...
    [Migration("20230928140901_AddedEmailInSupplier")]
    partial class AddedEmailInSupplier
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyStore.Domain.Customer", b =>
                {
            ...
            modelBuilder.Entity("MyStore.Domain.Employee", b =>
                {
            ...
            modelBuilder.Entity("MyStore.Domain.Num", b =>
                {
                    b.Property<int>("N")
                        .HasColumnType("int")
                        .HasColumnName("n");
            ...
            modelBuilder.Entity("MyStore.Domain.OrderDetail", b =>
                {
                    b.Property<int>("Orderid")
                        .HasColumnType("int")
                        .HasColumnName("orderid");
            ...
            modelBuilder.Entity("MyStore.Domain.Score", b =>
                {
            ...
            modelBuilder.Entity("MyStore.Domain.Shipper", b =>
                {
                    b.Property<int>("Shipperid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyStore.Domain.Supplier", b =>
                {
                    b.Property<int>("Supplierid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyStore.Domain.Test", b =>
                {
                    b.Property<string>("Testid")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("MyStore.Domain.Employee", b =>
                {
                    b.HasOne("MyStore.Domain.Employee", "Mgr")
                        .WithMany("InverseMgr")
                        .HasForeignKey("Mgrid")
            ...
            modelBuilder.Entity("MyStore.Domain.Order", b =>
                {
                    b.HasOne("MyStore.Domain.Customer", "Cust")
                        .WithMany("Orders")
                        .HasForeignKey("Custid")
                        .HasConstraintName("FK_Orders_Customers");

                    b.HasOne("MyStore.Domain.Employee", "Emp")
                        .WithMany("Orders")
                        .HasForeignKey("Empid")
                        .IsRequired()
                        .HasConstraintName("FK_Orders_Employees");

                    b.HasOne("MyStore.Domain.Shipper", "Shipper")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("MyStore.Domain.OrderDetail", b =>
                {
                    ...
                    b.HasOne("MyStore.Domain.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("MyStore.Domain.Product", b =>
                {
                    ...
                    b.HasOne("MyStore.Domain.Supplier", "Supplier")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("MyStore.Domain.Score", b =>
                {
                    b.HasOne("MyStore.Domain.Test", "Test")
                        .WithMany("Scores")

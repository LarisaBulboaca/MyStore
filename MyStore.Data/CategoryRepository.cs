...
namespace MyStore.Data
{
    public class CategoryRepository : ICategoryRepository
    {
        ...
        /*public IEnumerable<Category> GetAll(int page, string text)
        {
            var pageSize = 2;
            ...
            var categories =
                 storeContext
                .Categories
                .Where(x => x.Description.Contains(text))
                .Skip(pageSize * (page - 1))
                .Take(pageSize).ToList();
            return categories;
        }*/
        public IQueryable<Category> GetAll(int page, string? text)
        {
            ...
            if (!string.IsNullOrEmpty(text))
            {
                ...
                //categories = categories.Where(x => x.Description.Contains(text) || x.Categoryname.Contains(text));
